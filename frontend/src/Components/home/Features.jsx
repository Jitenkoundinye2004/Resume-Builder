...
const Features = () => {
    ...
    return (
        ...
        <div id='features' className='flex flex-col items-center my-0.1 scroll-mt-12'>
            <div className="flex items-center gap-2 text-sm text-[#385A3A] bg-[#385A3A]/10  rounded-full px-6 py-1.5">
                <Zap width={14}/>
                <span>Simple Process</span>
            </div>
            <Title title='Build your resume' description='Our streamlined process helps you to create a professional resume in minutes with intelligent AI-powered tools and features.'/>
