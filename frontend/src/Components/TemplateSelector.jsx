...
const TemplateSelector = ({selectedTemplate, onChange}) => {
    ...
    const templates =[
        ...
        },
        {
            id:"modern",
            name:"Modern",
            preview:"Sleek design wuth stractegic use of color and moderb font choices"
        },
        {
            id:"minimal-image",
            name:"Minimal Image",
  ...
  return (
    <div className='relative'>
        <button onClick={()=>setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg'>
